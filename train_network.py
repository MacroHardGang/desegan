...
def main(args):
    ...
    '''
    This fucking part makes sense
    '''
    if config.use_pretrained_encoder:
        dataset = dl.RawTextFace2TextDataset( #Reading from clean.json file
            annots_file=config.annotations_file,
            img_dir=config.images_dir, #"../data/LFW/lfw"
